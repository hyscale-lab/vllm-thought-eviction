...
# would WANT to keep distinguishable for the agent's reasoning (and they already
# decay via K_DEFAULTS); run/exec + other-bash are the high-volume, low-signal
# repeats (≈29-34% of tokens).
DEDUPE_OUTPUT_CATEGORIES = {MSA_TOOL_RUN_EXEC, MSA_TOOL_OTHER}
