...
class EngineCore:
    ...
    def get_request_l2_norms(self, request_id: str,
        ...
        try:
            ...
            valid_results = [n for n in all_norms
            ...
            if not all(len(n) == len(valid_results[0])
                       for n in valid_results):
                logger.warning(
                    "L2 norms from different workers have inconsistent "
                    "lengths")
            import numpy as np
