...
class SamplingParams(
    ...
    # --- Eviction fields (thought eviction) ---
    enable_l2_norms: bool = False
    """Whether to compute L2 norms of KV cache keys for this request."""
    l2_norm_layers: list[int] | None = None
    """Layers from which to compute L2 norms. None means all layers."""
